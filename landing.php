...
<?php while (have_posts()) : the_post(); ?>
    ...
    <br>
    <br>
    <h1 style="text-align:center; text-transform:uppercase; margin:0;">THE WORLD IS YOUR DANCEFLOOR</h1>
    <hr style="margin:0">
    <h2 style="text-align:center; text-transform:uppercase; margin:0;">Compagnie et école de danse à Genève</h2>
    <br>
    <br>
    <br>
    <br>
